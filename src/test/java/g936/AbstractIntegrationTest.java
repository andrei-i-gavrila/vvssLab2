...
public class AbstractIntegrationTest {
    ...
    protected void testAddStudentImpl() throws ValidatorException {
    ...
    protected void testAddAssignmentImpl() throws ValidatorException {
    ...
    protected void testAddGradeImpl() throws ValidatorException {
